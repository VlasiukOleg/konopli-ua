    ...
    <section className="section">
      <div className="container">
        ...
        <p className="text-sm md:text-sm xl:text-lg mb-3">
          ...
          безпечну продукцію з коноплі. Наші принципи: 100% натуральність і
          екологічність Виробництво в Україні Турбота про людину і природу
          Якість, що відчувається з першого дотику.
        </p>
        <p className="text-sm md:text-sm xl:text-lg mb-3">
