    ...
    <>
      ...
      >
        <CardBody className="p-1">
          ...
          <p className="text-black text-center font-bold text-sm leading-5">
            Гіпоаллергенна подушка
          </p>
          <p className="text-black text-center font-bold text-sm leading-5 mb-2">
            (сатинове покриття)
          </p>
      ...
      >
        <CardBody className="p-1">
          ...
          <p className="text-black text-center font-bold text-xs leading-4">
            Гіпоаллергенна подушка
          </p>
